	...
	function($rootScope, $scope, $timeout, $location, $stateParams, $state, $filter, serviceParameters, serviceTransactions, serviceCustomer, serviceMandates, serviceApplication, serviceMessageBroker, serviceTillManagement)
{
    ...
    $scope.LoadFunctionPageData = function(){
        ...
        serviceTransactions.LoadFunctionPageDefinitionData(functionId, accountNo)
        .then(
                    function (result) {    
    ...
    $scope.LoadDenominations = function(){
        ...
        serviceTransactions.LoadDenominations($scope.pageData.DepositoryId, $scope.pageData.AccountCurrency)
        .then(
        		function (result) {    
    ...
    $scope.getDenominationThumbnail = function(denomination)
    {
        ...
        return serviceParameters.ApplicationParams.ResourceDenominationPath + '/Teller_Denominations/' + $scope.pageData.AccountCurrency + '/' + imageName + '.png';
    }
